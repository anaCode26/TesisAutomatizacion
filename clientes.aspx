...
<body id="page-top">
    <form id="form2" runat="server">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container">
                <h2 class="text-uppercase mb-0">Clientes</h2>
                <br>
                <div class="alert alert-secondary" role="alert" style="width: 100%; height: 350px">
                    ...
                    <div class=" container ">
                        ...
                        <br>
                        <asp:TextBox ID="TextBox_agregarCliente" runat="server" Style="width: 450px; height: 41px; border-radius: 6px" placeholder="Ingrese nuevo cliente" autocomplete="off"></asp:TextBox>
                        <asp:Button ID="Boton_agregarCliente" type="button" runat="server" Text="Agregar cliente" class="btn btn-success" OnClick="BtnPrueba2_Click" />
                        <br>
                        <br>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server"  UpdateMode="Conditional " EnablePartialRendering="true" >
                            <ContentTemplate>--%>
                                <%-- <hr class="star-light">--%>
                                <asp:GridView ID="GridView1" runat="server" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="nombre">

                                    <AlternatingRowStyle BackColor="White" />

                                    <Columns>
                                        <asp:CommandField ShowSelectButton="True" SelectText="BORRAR" />

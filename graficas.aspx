<%@ Page Language="C#" AutoEventWireup="true" CodeFile="graficas.aspx.cs" Inherits="graficas" %>
...
<body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container">
            <h2 class="text-uppercase mb-0">Grafica</h2>
            <br>
            <div class="alert alert-secondary" role="alert" style="width: 100%; height: 350px" >
                <a href="#" class="alert-link"></a>
                 ...
                 <div class =" container ">
                     ...
                     <asp:DropDownList ID="DropDownList1" runat="server" Width="238px" class="btn btn-secondary dropdown-toggle .bg-secondary" ></asp:DropDownList>
                ...
                <asp:Chart ID="Grafica" runat="server" Height="244px" Palette="SeaGreen" >
                    ...
                    <Titles>
            <asp:Title Text="Tiempo de carga en milisegundos" />
        </Titles>
                </asp:Chart>
                    </div>
               </div>
